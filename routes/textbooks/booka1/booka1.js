const menu = [
    {
        ...
        list: [
            ...
            {id: 'famPetsThing', title: 'Family, Pets, & Posessions'},
...
function createMenu(){
    ...
    menu.forEach(eachChapter => {
        //create button first
        const button = `<button class="panel">${eachChapter.title}</button>`;
        container.append(button)

        //create our list
        let list = `<ul class='area' id="${eachChapter.id}">`;
        eachChapter.list.forEach(singleListItem => {
